...
import com.example.burgerapp.models.Burger
import com.example.burgerapp.util.Price
...
class BurgerAdapter(
    ...
    inner class BurgerVH(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val btn: com.google.android.material.button.MaterialButton = view.findViewById(R.id.btnAdd)
    }
